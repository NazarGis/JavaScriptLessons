...
// load gallery
let url = "https://pixabay.com/api/?key=17057678-b4c4954d8c62e2cb084b2680c&q=ring+lord&image_type=photo&pretty=true"
...
function showImg(list){
    ...
    //calculate width
    imgList.style.width = list.length * 150 + 'px'
    ...
    smallLeftArr.addEventListener('click',()=>{
       imgListLeft = moveLeft(imgList, imgListWidth, imgListLeft)
        // if(-(imgListWidth-150*5) < imgListLeft ){
...
//+Завантажити фото
//+Відобразити перше фото у bigSlider
//+Зробити активним елемент списка
//Завантажувати у bigSlider зі списку за кліком
//+Відслідковування активного фото
//+Перегортування фото з bigSlider
//Переміщення вибраного елемента в списку
//+Прокрутка малими стрілками
